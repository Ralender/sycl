...
=======
// RUN: %clang -std=c++17 -fsycl -c -o %t.kernel.o %s -DINIT_KERNEL -DCALC_KERNEL
// RUN: %clang -std=c++17 -fsycl -c -o %t.main.o %s -DMAIN_APP
// RUN: %clang -std=c++17 -fsycl %t.kernel.o %t.main.o -o %t.fat -lstdc++ -lOpenCL -lsycl
>>>>>>> sycl/unified/master
...
=======
// RUN: %clang -std=c++17 -fsycl -c -o %t.init.o %s -DINIT_KERNEL
// RUN: %clang -std=c++17 -fsycl -c -o %t.calc.o %s -DCALC_KERNEL
// RUN: %clang -std=c++17 -fsycl -c -o %t.main.o %s -DMAIN_APP
// RUN: %clang -std=c++17 -fsycl %t.init.o %t.calc.o %t.main.o -o %t.fat -lstdc++ -lOpenCL -lsycl
>>>>>>> sycl/unified/master
// RUN: env SYCL_DEVICE_TYPE=HOST %t.fat
// RUN: %CPU_RUN_PLACEHOLDER %t.fat
// RUN: %GPU_RUN_PLACEHOLDER %t.fat
